...
export class YoutubeapiserviceService {
  ...
  getChannels(channelName: string): Observable<any> {
    ...
    const url_search = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + channelName + "&type=channel&key=" + api_key_youtube + "&maxResult=50";
  ...
  getVideos(videoName: string): Observable<any> {
    ...
    const url_search_video = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + videoName + "&type=videos&key=" + api_key_youtube + "&maxResult=50";
